# Final Presentation Content Requirements Redesign

## Goal

Revise the Content Requirements section of `project/final-presentation.md` to optimize for:

1. **Transferable business skills** — students practice presenting the way professionals present to clients, executives, and stakeholders
2. **Engaging, entertaining presentations** — each presentation tells a story and teaches the audience something
3. **Student confidence** — students walk away feeling they gave the best presentation of their life

## Audience

Peers and fellow students presenting that day, project stakeholders, ISBA department faculty, and capstone advisors.

## Design Approach

**Structured Storytelling Hybrid (Approach B):** Keep recognizable section structure but rewrite the guidance within each section to emphasize narrative, audience engagement, and business-transferable skills. Familiar structure gives students a safety net while the new guidance pushes toward storytelling.
...
|---|---|---|
| **Delivery Policy** | New | No-reading rule with letter grade penalty, placed before content requirements |
| **Introduction (2-3 min)** | Revised | Subfields moved to visual tags on title/elevator pitch slide, not narrated |
| **Problem & Stakes (2-3 min)** | Revised | Merged target user + problem; "feel the problem" framing; translate jargon guidance |
| **Solution & Demo (5-7 min)** | Revised | Subfields woven into demo; explicit before/after contrast; methodology framing removed |
| **Key Decisions (2-3 min)** | New (replaces methodology) | 1-2 decisions/pivots/tradeoffs with reasoning |
| **Reflection (1-2 min)** | Revised | "What I Know Now That I Didn't Before" replaces separate challenge + lesson learned |
| **Closing Slide** | Revised | Added "lingers during Q&A" framing; updated resources (SWD, Duarte TED, HBR) |
| **Slide Titles** | New (added to Visual Aids) | Takeaway/action/insight titles required; comparison table; SWD resource |
| **Time Allowed** | Revised | Two timing tiers; non-verbal 1-minute warning; hard stop; "practice with a timer" |

**Unchanged sections:** Presentation Schedule, Deliverables, Attire, Attendance Policy, Visual Aids (1-5-5-5 rule and existing guidance), Q&A, bottom Resources.

---

## Detailed Specifications

### 1. Delivery Policy (new section — placed before Content Requirements)
...
### 8. Slide Titles (addition to Visual Aids section)
...
## Resources (bottom of document — updated)

- [Storytelling with Data: A Data Visualization Guide for Business Professionals](https://www.storytellingwithdata.com/) (existing, unchanged)
- Apply the presentation tips from Garr Reynolds, author of *Presentation Zen: Simple Ideas on Presentation Design and Delivery*: Prepare, Design, Deliver (existing, unchanged)
...
- Sections not listed above (Presentation Schedule, Deliverables, Attire, Attendance Policy, Visual Aids core guidance, Q&A) remain unchanged
- The ISBA subfields numbered list remains in the Introduction section for reference but is no longer narrated during the presentation
