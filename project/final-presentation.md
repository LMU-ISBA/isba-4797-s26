# Capstone Project Final Presentation - Spring 2026
...
1. **1** main idea per slide
2. Limit to **5** bullet points or lines of text max
3. Use a maximum of **5** words per bullet point or line
