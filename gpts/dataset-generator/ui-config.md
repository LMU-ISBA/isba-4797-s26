...
**Name**: ISBA 4797 Data Craft

**Description**:
Generate realistic practice datasets for Capstone Project projects. Creates custom datasets with configurable data quality issues for analysis practice.
